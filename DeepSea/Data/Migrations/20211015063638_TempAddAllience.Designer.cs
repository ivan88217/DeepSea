...
namespace DeepSea.Data.Migrations
{
    ...
    [Migration("20211015063638_TempAddAllience")]
    partial class TempAddAllience
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeepSea.Models.HouseMemberDeatil", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeepSea.Models.HouseMemberDeatil", b =>
                {
                    ...
                    b.HasOne("DeepSea.Models.HouseMember", "HouseMember")
                        .WithOne("Detail")
                        .HasForeignKey("DeepSea.Models.HouseMemberDeatil", "HouseMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
