...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeepSea.Models.AttendanceRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeepSea.Models.AttendanceRecordDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AttendanceRecordDetail", (string)null);
                });

            modelBuilder.Entity("DeepSea.Models.AttendanceTempRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AttendanceTempRecord", (string)null);
                });
            ...
            modelBuilder.Entity("DeepSea.Models.HouseMember", b =>
                {
                    ...
                    b.ToTable("HouseMember", (string)null);
                });

            modelBuilder.Entity("DeepSea.Models.HouseMemberDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("HouseMemberDetail", (string)null);
                });
            ...
            modelBuilder.Entity("DeepSea.Models.TeamUsersUnitDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TeamUsersUnitDetail", (string)null);
                });
            ...
            modelBuilder.Entity("DeepSea.Models.UserOwnUnits", b =>
                {
                    ...
                    b.ToTable("MemberOwnUnits", (string)null);
                });
            ...
            modelBuilder.Entity("DeepSea.Models.AttendanceRecordDetail", b =>
                {
                    b.HasOne("DeepSea.Models.AttendanceRecord", "AttendenceRecord")
                        .WithMany("Details")
                    ...
                    b.HasOne("DeepSea.Models.HouseMember", "HouseMember")
                        .WithMany("AttendenceRecordDetails")
            ...
            modelBuilder.Entity("DeepSea.Models.AttendanceTempRecord", b =>
                {
                    b.HasOne("DeepSea.Models.Alliance", "Alliance")
                        .WithMany("AttendenceTempRecords")
                        .HasForeignKey("AllianceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DeepSea.Models.HouseMember", "HouseMember")
                        .WithOne("AttendenceTempRecord")
                        .HasForeignKey("DeepSea.Models.AttendanceTempRecord", "HouseMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DeepSea.Models.HouseMemberDetail", b =>
                {
                    ...
                    b.HasOne("DeepSea.Models.HouseMember", "HouseMember")
                        .WithOne("Detail")
                        .HasForeignKey("DeepSea.Models.HouseMemberDetail", "HouseMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DeepSea.Models.TeamUsersUnitDetail", b =>
                {
                    b.HasOne("DeepSea.Models.TeamUsers", "TeamUsers")
                        .WithMany("Detail")
            ...
            modelBuilder.Entity("DeepSea.Models.Alliance", b =>
                {
                    ...
                    b.Navigation("AttendenceTempRecords");
            ...
            modelBuilder.Entity("DeepSea.Models.House", b =>
                {
                    b.Navigation("OwnMembers");
                });

            modelBuilder.Entity("DeepSea.Models.HouseMember", b =>
                {
                    b.Navigation("AttendenceRecordDetails");

                    b.Navigation("AttendenceTempRecord")
                        .IsRequired();
